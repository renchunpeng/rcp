package com.lvfulo.controller.ord.alipay.util;
...
import com.lvfulo.controller.ord.alipay.sign.MD5;
...
public class AlipaySubmit {
  ...
  public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {  
      ...
      //添加微信 兼容性  
//      sbHtml.append("<script type='text/javascript' src='/lflweb/js/ap.js'></script>");  
