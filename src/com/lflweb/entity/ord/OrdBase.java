...
public class OrdBase implements BaseBean,Cloneable {
	...
	//关联的优惠券信息
	private ActUserCoupon actUserCoupon;
...
//		this.commentdate = null;
		...
		this.generatetype = "";
		this.orderfather = "";
		this.ctmAddress = new CtmAddress();
		this.actUserCoupon = new ActUserCoupon();
	}
	

	public ActUserCoupon getActUserCoupon() {
		return actUserCoupon;
	}

	public void setActUserCoupon(ActUserCoupon actUserCoupon) {
		this.actUserCoupon = actUserCoupon;
	}

	public CtmAddress getCtmAddress() {
		return ctmAddress;
	}

	public void setCtmAddress(CtmAddress ctmAddress) {
