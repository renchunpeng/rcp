...
public class ActInvoiceTrans implements BaseBean,Cloneable {
	...
	//新增
	//发票主流水号
	private String invoicefather;

	public ActInvoiceTrans() {
		this.OnInit();
	}
  ...
  @Override  
  public Object clone() {  
      ActInvoiceTrans stu = null;  
      try{  
          stu = (ActInvoiceTrans)super.clone();  
...
//		this.expressdate = ToolUtils.GetMinDate();
	...
	public String getInvoicefather() {
		return invoicefather;
	}

	public void setInvoicefather(String invoicefather) {
		this.invoicefather = invoicefather;
	}
