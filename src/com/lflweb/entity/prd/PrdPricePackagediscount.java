...
public class PrdPricePackagediscount implements BaseBean {
	...
	private SelectBean<PrdPricePackagediscount> item;

	public PrdPricePackagediscount() {
		this.OnInit();
	}
	...
	public String OnCompare(BaseBean item) throws Exception {
		return ToolUtils.CompareProperty((PrdPricePackagediscount)item, this, this.OnProperties());
	}
	...
	public SelectBean<PrdPricePackagediscount> getItem() {
		if (item == null)
			item = new SelectBean<PrdPricePackagediscount>();

		return item;
	}

	public void setItem(SelectBean<PrdPricePackagediscount> item) {
		this.item = item;
	}
