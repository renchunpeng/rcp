...
public class PrdPriceFullcut implements BaseBean {
	...
	private SelectBean<PrdPriceFullcut> item;

	public PrdPriceFullcut() {
		this.OnInit();
	}
	...
	public String OnCompare(BaseBean item) throws Exception {
		return ToolUtils.CompareProperty((PrdPriceFullcut)item, this, this.OnProperties());
	}
	...
	public SelectBean<PrdPriceFullcut> getItem() {
		if (item == null)
			item = new SelectBean<PrdPriceFullcut>();

		return item;
	}

	public void setItem(SelectBean<PrdPriceFullcut> item) {
		this.item = item;
	}
